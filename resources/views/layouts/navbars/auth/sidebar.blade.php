...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
        ...
        <span class="ms-3 font-weight-bold">Payment Platform</span>
    </a>
  </div>
...
{{--      </li>--}}
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('payment-method') ? 'active' : '') }}" href="{{ route('payment-method.index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('payment-method') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
